...
function MENU:GeneratorPanel(genEnt)
	...
	genInfo:Dock(RIGHT)
	genInfo:DockMargin(5,self.frame:GetTall()*(45/500),self.frame:GetWide()*(50/750),self.frame:GetTall()*(45/500))
	...
	bombsList:Dock(FILL)
	bombsList:DockMargin(self.frame:GetWide()*(50/750),self.frame:GetTall()*(45/500),5,self.frame:GetTall()*(45/500))
